...
class ChangerView(wx.Frame):
    def __init__(self, parent):
        ...
        self.labelClk = wx.StaticText(self.panel, -1, "Clock Delayer")
        self.sliderPps = wx.Slider(self.panel, -1, 0, 0, 100, (10, 10), (250, 50),
                                  wx.SL_HORIZONTAL | wx.SL_AUTOTICKS | wx.SL_LABELS)
        self.labelPps = wx.StaticText(self.panel, -1, "Firint Rate PPS")
...
#        self.label1.SetBackgroundColour((self.Red1, self.Green1, self.Blue1))
        ...
        self.hbox.Add(self.sliderPps, border=5, flag=wx.ALL|wx.EXPAND)
        self.hbox.Add(self.labelPps, flag=wx.ALIGN_CENTER, border=5)
...
class Controller:
    def __init__(self, app):
        ...
        self.ctrlView.sliderPps.Bind(wx.EVT_SLIDER, self.SendPps)
